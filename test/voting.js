...
contract('Voting', (accounts) => {
  ...
  it('should create a new ballot', async () => {
    ...
    // assert(ballot._choices === ['Choice 1', 'Choice 2', 'Choice 3']); //Solidity does not know how to return an array of struct inside another struct
  });
  ...
  it('should NOT vote after the ballot has ended', async () => {
    await voting.createBallot(
      'Ballot 4',
      ['Choice 1', 'Choice 2', 'Choice 3'],
      5,
